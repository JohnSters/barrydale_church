...
export const useSermons = routeLoader$(async (): Promise<Sermon[]> => {
...
const SermonCard = component$((sermon: Sermon) => {
  ...
  const download = $(() => {
    const proxyUrl = `/api/download?url=${encodeURIComponent(sermon.sermon_mp3_url!)}`;
        ...
        <div class="sermon-actions">
          ...
          <div class="sermon-buttons">
            ...
            <div class="share-wrapper">
              <button
                class="btn sermon-btn sermon-share-btn"
                title="Share sermon"
                onClick$={openShare}
              >
              ...
              {shareOpen.value && (
                <div class="share-popover">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="share-option share-telegram"
                    onClick$={() => { shareOpen.value = false; }}
                  >
  ...
  return (
    <>
      <section
        ...
        style={{
          background:
            "linear-gradient(rgba(44, 62, 80, 0.65), rgba(44, 62, 80, 0.75))",
  ...
  meta: [
    {
      name: "description",
      content:
        "Listen to and download sermon recordings from Barrydale Christian Fellowship.",
    },
  ],
};
